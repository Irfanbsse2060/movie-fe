Authored: irfan.htc40@gmail.com
...
**Note: make sure to create .env file and set envirnment variables before running the project. Please check out
.env.example file to know which variables need to set.**
